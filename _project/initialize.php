<?php
    ...
    function loadPage($link, $type="internal") {
        ...
        if ($type == "internal") {
            ...
            echo "<data-ddpage url='hash-$link' type='$type' style='display: none'>";
	...
	function loadHeader($link = 'main') {
		...
		if (!isset($_SERVER['HTTP_DODO'])) {
			...
			echo "<link rel='stylesheet' href='".UI."/$page_link/styles.css'>";
		}
	}
	...
	function loadFooter($link = 'main') {
		...
		echo "<script src='". FRONTEND ."$page_link/main.js'></script>";
